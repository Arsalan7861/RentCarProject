...
{
    /// <inheritdoc />
    public partial class I_added_protectionPackage_table : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Coverage", x => new { x.ProtectionPackageId, x.Id });
                    table.ForeignKey(
                        name: "FK_Coverage_ProtectionPackages_ProtectionPackageId",
