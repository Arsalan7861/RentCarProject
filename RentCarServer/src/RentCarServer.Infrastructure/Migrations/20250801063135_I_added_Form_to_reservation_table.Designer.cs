...
namespace RentCarServer.Infrastructure.Migrations
{
    ...
    [Migration("20250801063135_I_added_Form_to_reservation_table")]
    partial class I_added_Form_to_reservation_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentCarServer.Domain.Customers.Customer", b =>
                {
                    ...
                    b.OwnsOne("RentCarServer.Domain.Shared.Password", "Password", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Customers.ValueObjects.BirthDate", "BirthDate", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Customers.ValueObjects.DrivingLicenseIssuanceDate", "DrivingLicenseIssuanceDate", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Customers.ValueObjects.FullAddress", "FullAddress", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Customers.ValueObjects.IdentityNumber", "IdentityNumber", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Customers.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentCarServer.Domain.ProtectionPackages.ProtectionPackage", b =>
                {
                    ...
                    b.OwnsMany("RentCarServer.Domain.ProtectionPackages.ValueObjects.Coverage", "Coverages", b1 =>
                        {
                            b1.Property<Guid>("ProtectionPackageId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentCarServer.Domain.Reservations.Reservation", b =>
                {
                    b.OwnsOne("RentCarServer.Domain.Reservations.Forms.Form", "DeliveryForm", b1 =>
                        {
                            ...
                            b1.OwnsMany("RentCarServer.Domain.Reservations.Forms.ValueObjects.Damage", "Damages", b2 =>
                                {
                            ...
                            b1.OwnsMany("RentCarServer.Domain.Shared.ImageUrl", "ImageUrls", b2 =>
                                {
                                    b2.Property<Guid>("FormReservationId")
                                        .HasColumnType("uniqueidentifier");
                            ...
                            b1.OwnsMany("RentCarServer.Domain.Reservations.Forms.ValueObjects.Supply", "Supplies", b2 =>
                                {
                                    b2.Property<Guid>("FormReservationId")
                                        .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Reservations.Forms.Form", "PickUpForm", b1 =>
                        {
                            b1.Property<Guid>("ReservationId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Reservations.ValueObjects.PaymenyInformation", "PaymentInformation", b1 =>
                        {
                            b1.Property<Guid>("ReservationId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("RentCarServer.Domain.Reservations.ValueObjects.ReservationExtra", "ReservationExtras", b1 =>
                        {
                            b1.Property<Guid>("ReservationId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Reservations.ValueObjects.Total", "Total", b1 =>
                        {
                            b1.Property<Guid>("ReservationId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentCarServer.Domain.Vehicles.Vehicle", b =>
                {
                    ...
                    b.OwnsOne("RentCarServer.Domain.Shared.ImageUrl", "ImageUrl", b1 =>
                        {
                            b1.Property<Guid>("VehicleId")
                                .HasColumnType("uniqueidentifier");
